...
ctx.createInstance();`,
  ...
  {
    id: "system.updateBanner",
    type: "launcher-update-banner",
    label: "Aviso de actualización",
    description: "Aparece solo si hay una versión nueva en el admin (no bloquea el launcher)",
    category: "account",
    defaultWidth: 360,
    defaultHeight: 72,
    defaultLabel: "Nueva actualización disponible",
    defaultAction: "none",
    preset: {
      style: {
        borderRadius: 12,
  ...
  {
    id: "chat.bubbleToggle",
    type: "chat-bubble-toggle",
    label: "Burbuja chat",
    description: "Botón para abrir/cerrar el chat. Crea el panel completo (cabecera, pestañas, historial…) listo para mover y redimensionar.",
    category: "chat",
    defaultWidth: 52,
    defaultHeight: 52,
    defaultLabel: "Chat",
    ...
    preset: {
      hubGroup: "chat",
      style: { borderRadius: 999, backgroundColor: "#7c83ff", textColor: "#ffffff" },
    },
  },
  {
    id: "chat.header",
    type: "chat-header",
    label: "Cabecera chat",
    description: "Título del panel — arrastra desde aquí para mover la burbuja",
    category: "chat",
    defaultWidth: 320,
    defaultHeight: 44,
    defaultLabel: "Mensajes",
    defaultAction: "none",
    preset: { hubGroup: "chat", visible: true },
  },
  {
    id: "chat.tabs",
    type: "chat-tabs",
    label: "Pestañas chat",
    description: "Amigos / Explorar",
    category: "chat",
    defaultWidth: 320,
    defaultHeight: 36,
    defaultLabel: "Tabs",
    defaultAction: "none",
    preset: { hubGroup: "chat" },
  },
  {
    id: "chat.panel",
    type: "chat-panel",
    label: "Historial chat",
    description: "Mensajes, amigos y explorar",
    category: "chat",
    defaultWidth: 320,
    defaultHeight: 260,
  ...
  },
  {
    ...
    type: "chat-input",
    label: "Barra mensaje",
    description: "Campo de texto del chat",
    category: "chat",
    defaultWidth: 240,
    defaultHeight: 36,
    defaultLabel: "Escribe un mensaje…",
    defaultAction: "none",
    preset: { hubGroup: "chat" },
  },
  {
    ...
    defaultLabel: "Enviar",
    defaultAction: "none",
    preset: { hubGroup: "chat", style: { backgroundColor: "#7c83ff", textColor: "#fff", borderRadius: 10 } },
  },
  {
    id: "chat.close",
    type: "chat-close",
    label: "Cerrar chat",
    description: "Cierra la burbuja o vuelve de conversación",
    category: "chat",
    defaultWidth: 36,
    defaultHeight: 36,
    defaultLabel: "✕",
  ...
  {
    id: "chat.resize",
    type: "chat-resize-handle",
    label: "Redimensionar chat",
    description: "Cambia tamaño mini / normal / grande",
    category: "chat",
    defaultWidth: 32,
    defaultHeight: 32,
    defaultLabel: "⤢",
